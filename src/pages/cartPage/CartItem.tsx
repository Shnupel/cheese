...
const CartItem: React.FC = () => {
  ...
  let [productCounter, setProductCounter] = React.useState(0);
  ...
  React.useEffect(() => {
    setData((prevData) => { return { ...prevData, counter: productCounter } })
  }, [productCounter]);
      ...
      <div className={ style.content }>
        ...
        <div className={ style.buy }>
          ...
          <div className={ style.controlCounter }>
            ...
            <div style={{ flex: "1 1 auto" }} className="button --orange">купить</div>
          </div>
