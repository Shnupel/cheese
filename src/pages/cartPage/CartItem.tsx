...
const CartItem: React.FC = () => {
  return (
    <div className={ style.item }>
      <div className={ style.title }>Мезофильная закваска Hansen Flora Danica (50U)</div>
      <div className={ style.content }>
        <div className={ style.img }>
          <img src={ productImg } alt="" className={ style.fullImg } />
          <img src={ productImg } alt="" className={ style.slimImg } />
        </div>
        <div className={ style.buy }>
          ...
          <div className={ style.controlCounter }>
            <div className={ style.counter }>
              <button className={ style.operand }><svg width="22" height="22" fill="rgba(41, 41, 41, 1)" className="bi bi-dash" viewBox="0 0 16 16"><path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z"/></svg></button>
              <div className={ style.count }>3</div>
              <button className={ style.operand }><svg width="22" height="22" fill="rgba(41, 41, 41, 1)" className="bi bi-plus" viewBox="0 0 16 16"><path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/></svg></button>
            </div>
            <div style={{ flex: "1 1 auto" }} className="button --orange">counter</div>
          </div>
      ...
      <div className={ style.tabsWrapper }>
        ...
        <div className={ style.tabsContent }>
          <div className={ style.tabContent }>P00802 Эта форма небольших размеров предназначена для получения маленьких головок сыра Рикотта и других мягких сыров в условиях домашнего или фермерского производства. Наличие хорошего дренажа обеспечивает ее использование для прессования сыров с плесенью, в том числе сорта Французский нешатель. Размер сырной головки, которую удается получить при использовании этой формы – до 80 г. Это аккуратный, готовый к подаче кусочек сыра, который не придется нарезать. Изготовлена форма из специального высококачественного пищевого пластика, который хорошо адаптирован к агрессивной молочнокислой среде.</div>
        </div>
      </div>
